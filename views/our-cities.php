                    ...
                    <div class="row">
                        <div class="col-12 section-title-container">
                            <div class="section-title">
                                <h2>Lugares <span class="hide-xs">con pasión<span class="hide-xs"></h2>
                                <span class="subtitle"><span class="hide-xs">Lugares</span> con pasión</span>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4">
                            <a href="#" target="_blank" class="card main-card">
                                <div class="card-img-wrap">
                                    ...
                                    <img src="../includes/img/news-hover.png" alt="hover" class="news-hover">
                                </div>
                                <div class="card-body">
