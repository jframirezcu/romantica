<!DOCTYPE html>
 ...
 <head>
    ...
    <!-- Site proper css -->
 	<link rel="stylesheet" href="../includes/css/index.css" id="js-style-site">

    <script src="//servicios-mega.mdstrm.com/resources/js/dfp/dfp-2.2.min.js" data-path="/romantica.cl/home/home/" id="js-mega-script"></script>
            ...
            <div id="nav-open-bg" class="site-parallax">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 mobile-wrap">
                            <div id="mainCarousel" class="carousel slide slider-news-section js-link-static">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <div class="carousel-caption col-12 col-lg-3">
                                            <a href="http://localhost/romantica/views/single_dev.php">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <!-- news section -->
                            <div class="row news-index-section js-link-static">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <a href="http://localhost/romantica/views/single_dev.php" target="" class="card main-card">
